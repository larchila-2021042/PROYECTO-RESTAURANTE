    ...
    <div id="main-header" class="py-2 bg-light text-dark" >
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <h1>
                        <i class="fas fa-user-cog"></i>Control Postres
                    </h1>
                </div>
                <div  class="col-4"></div>
            </div>
        ...
        <div class="row ">
            <div class="col-md-12 col-sm-12 col-12 upbar">
                <hr class="lineas-separacion">
                    <button type="button" class="btn btn-secondary btn-agregar">Agregar Postre</button>
                <hr class="lineas-separacion">
            </div>
        </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-xl-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${data}" var="postre">
                                    <tr>
                                        <td>${postre.id}</td>
                                        <td>${postre.nombre}</td>
                                        <td>${postre.descripcion}</td>
                                        <td>${postre.precio}</td>
                                        <td>${postre.descuento}</td>
                                        <td>${postre.rutaImagen}</td>
                                        <td>
