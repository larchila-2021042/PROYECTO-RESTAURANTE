<%-- 
    Document   : desayunos
    Created on : Sep 2, 2022, 2:48:18 PM
    Author     : W10
--%>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class=" col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card card-inicio" style="width: 18rem;">
                    <img src="./assets/images/MENUS/desayunos/menu_zuppe.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Xibal Zuppe</h5>
                        <p class="card-text">Combo fenomenal si para los amantes de la comida italiana. Incluye un Pie de Queso, Carpaccio Il Jamone y un Te frio.</p>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4 ">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/desayunos/menu_parmigiana.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Parmigiana</h5>
                        <p class="card-text">Un combo para relajarse de manana. que incluye un Crepa con Nutella, Mostaccioli y un Cafe Negro.</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/desayunos/menu_desayuno_1.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo desayuno 1</h5>
                        <p class="card-text">Combo fenomenal si comienzas el dia. Incluye un Pie de Queso, Ravioles in Rossa y un Jugo de naranja.</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
