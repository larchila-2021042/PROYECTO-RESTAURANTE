        ...
        <div class="row ">
            <div class="col-md-12 col-sm-12 col-12 upbar">
                <hr class="lineas-separacion">
                    <button type="button" class="btn btn-secondary btn-agregar">Agregar Bebida</button>
                <hr class="lineas-separacion">
            </div>
        </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-xl-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${data}" var="bebida">
                                    <tr>
                                        <td>${bebida.id}</td>
                                        <td>${bebida.nombre}</td>
                                        <td>${bebida.descripcion}</td>
                                        <td>${bebida.precio}</td>
                                        <td>${bebida.descuento}</td>
                                        <td>${bebida.rutaImagen}</td>
                                        <td>
