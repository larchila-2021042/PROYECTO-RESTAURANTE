        ...
        <div class="row ">
            <div class="col-md-12 col-sm-12 col-12 upbar">
                <hr class="lineas-separacion">
                    <button type="button" class="btn btn-secondary btn-agregar">Agregar Platillos</button>
                <hr class="lineas-separacion">
            </div>
        </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-xl-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${data}" var="platillo">
                                    <tr>
                                        <td>${platillo.id}</td>
                                        <td>${platillo.nombre}</td>
                                        <td>${platillo.descripcion}</td>
                                        <td>${platillo.precio}</td>
                                        <td>${platillo.descuento}</td>
                                        <td>${platillo.rutaImagen}</td>
                                        <td>
