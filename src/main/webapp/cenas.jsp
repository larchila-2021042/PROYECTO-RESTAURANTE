<%-- 
    Document   : cenas
    Created on : Sep 2, 2022, 2:47:20 PM
    Author     : W10
--%>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class=" col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card card-inicio" style="width: 18rem;">
                    <img src="./assets/images/MENUS/cenas/menu_fit.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo FIT</h5>
                        <p class="card-text">Combo fenomenal si guardas la linea. Incluye un Helado,una Ensalada y un Te frio.</p>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4 ">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/cenas/menu_casual.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Casual</h5>
                        <p class="card-text">Un combo que incluye un Helado un delicioso Minestrone y una Limonada.</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/cenas/menu_frutti.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Frutti</h5>
                        <p class="card-text">Incluye un Cañoncito de Nutella, Rissoto Stracceti y un Capuchinno.</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
