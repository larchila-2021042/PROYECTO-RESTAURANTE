        ...
        <div class="row ">
            <div class="col-md-12 col-sm-12 col-12 upbar">
                <hr class="lineas-separacion">
                    <button type="button" class="btn btn-secondary btn-agregar">Agregar Almuerzo</button>
                <hr class="lineas-separacion">
            </div>
        </div>
            </div>
                            ...
                            <tbody>
                                <c:forEach items="${data}" var="almuerzo">
                                    <tr>
                                        ...
                                        <td>${almuerzo.postreId}</td>
                                        <td>${almuerzo.nombrePostre}</td>
                                        <td>${almuerzo.platilloId}</td>
                                        <td>${almuerzo.nombrePlatillo}</td>
                                        <td>${almuerzo.bebidaId}</td>
                                        <td>${almuerzo.nombreBebida}</td>
                                        <td>${almuerzo.precio}</td>
                                        <td>${almuerzo.rutaImagen}</td>
                                        <td>${almuerzo.tiempo}</td>
                                        <td>
