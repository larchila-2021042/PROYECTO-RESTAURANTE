<%-- 
    Document   : almuerzos
    Created on : Sep 2, 2022, 2:44:54 PM
    Author     : W10
--%>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class=" col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card card-inicio" style="width: 18rem;">
                    <img src="./assets/images/MENUS/almuerzos/menu_almuerzo_1.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Almuerzo 1</h5>
                        <p class="card-text">Un combo ideal para aquellos que disfruten a lo italian. Incluye Pie de Manzana, Calzone Italianisimo y una Clasica Coca-Cola.</p>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3 ">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/almuerzos/menu_pasta.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Pasta 1</h5>
                        <p class="card-text">Un combo clasico para los amantes de la pasta. Incluye una Banana Split, una deliciosa Lasana dalla Casa, y un Te frio</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/almuerzos/ class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Cacciatora</h5>
                        <p class="card-text">Combo perfecto para unos bonitos recuerdos. Inclute Cinnamon Rolls, Exquisita Pasta a la Carbonara y una Malteada De Fresa.</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3 ">
                <div class="card" style="width: 18rem;">
                    <img src="./assets/images/MENUS/almuerzos/menu_pizza.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Combo Pizza</h5>
                        <p class="card-text">Un combo para quedar saciados. Incluye un Croissant simple, una deleitosa Pizza Margherita y una Horchata</p>
                        <button class="my-button botonResta">-</button>
                        <input type="text" id="mostrador">                        
                        <button class="my-button botonSuma">+</button>
                            <a href="#" class="btn btn-primary btn-anadir-carrito">Añadir al carrito</a>
